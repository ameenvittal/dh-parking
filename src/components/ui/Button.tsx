...
const buttonVariants = cva(
  'inline-flex shrink-0 select-none items-center justify-center gap-2 whitespace-nowrap rounded-md font-semibold transition-colors outline-none focus-visible:ring-2 focus-visible:ring-focus focus-visible:ring-offset-2 focus-visible:ring-offset-surface disabled:pointer-events-none disabled:opacity-50 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        primary: 'bg-primary text-on-primary hover:bg-primary-hover active:bg-primary-hover',
        secondary: 'border border-line-strong bg-surface text-ink hover:bg-surface-2 active:bg-surface-2',
        ghost: 'bg-transparent text-ink hover:bg-surface-2 active:bg-surface-2',
        danger: 'bg-danger text-on-primary hover:opacity-90 active:opacity-90',
        'danger-ghost': 'bg-transparent text-danger hover:bg-danger-soft active:bg-danger-soft',
